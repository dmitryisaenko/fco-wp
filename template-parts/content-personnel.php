...
<main>
        <div class="breadcrumb-wrapper">
            <div class="breadcrumb"><a href="<?=home_url(); ?>">Головна</a> / <span><span>Команда</span> / <?=get_post(get_post()->post_parent)->post_title;?> / Персонал</span></div>
        </div>
        ...
        <section class="main-container container">
            ...
            <div class="team-header">
                <ul>
                    ...
                    <li><a href="#" class="active">Персонал</a></li>
                </ul>
            </div>
            <div class="team-block">
                <div class="w100 team-block-items-wrapper">
                    <? fco_member_items(get_parentName(), 'personnel') ?>
                </div>
            </div>
